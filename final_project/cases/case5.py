...
#
# Case 5 intentionally uses a prediction threshold that is
# too high, making the classifier overly conservative.
#
# It performs:
# 1. Data loading
# 2. Train/test split
...
def main():
    ...
    plt.title("MLP Training and Validation Loss (Case 5)")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(visuals_dir / "mlp_loss_curve_case5.png", dpi=200)
    plt.show()

    print("\nLoss curve saved as final_project/visuals/mlp_loss_curve_case5.png")
    ...
    plt.title("Confusion Matrix (MLP Case 5)")
    plt.colorbar()
    ...
    plt.tight_layout()
    plt.savefig(visuals_dir / "mlp_confusion_matrix_case5.png", dpi=200)
    plt.show()

    print("Saved: final_project/visuals/mlp_confusion_matrix_case5.png")
    ...
    plt.ylabel("Count")
    plt.title("Predicted Probability Distribution by Class (Case 5)")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(visuals_dir / "mlp_probability_distribution_case5.png", dpi=200)
    plt.show()

    print("Saved: final_project/visuals/mlp_probability_distribution_case5.png")
    ...
    plot_model(
        model,
        to_file=str(visuals_dir / "mlp_architecture_case5.png"),
        show_shapes=True,
        show_layer_names=True,
        dpi=200
    )

    print("Saved: final_project/visuals/mlp_architecture_case5.png")

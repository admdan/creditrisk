...
#
# Case 6 intentionally changes the output activation from
# sigmoid to ReLU, which is inappropriate for binary
...
def main():
    ...
    model = keras.Sequential([
        ...
        layers.Dropout(0.20),
        layers.Dense(1, activation="relu")  # intentional bug
    ])
    ...
    plt.title("MLP Training and Validation Loss (Case 6)")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(visuals_dir / "mlp_loss_curve_case6.png", dpi=200)
    plt.show()

    print("\nLoss curve saved as final_project/visuals/mlp_loss_curve_case6.png")
    ...
    plt.title("Confusion Matrix (MLP Case 6)")
    plt.colorbar()
    ...
    plt.tight_layout()
    plt.savefig(visuals_dir / "mlp_confusion_matrix_case6.png", dpi=200)
    plt.show()

    print("Saved: final_project/visuals/mlp_confusion_matrix_case6.png")
    ...
    plt.ylabel("Count")
    plt.title("Predicted Output Distribution by Class (Case 6)")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(visuals_dir / "mlp_probability_distribution_case6.png", dpi=200)
    plt.show()

    print("Saved: final_project/visuals/mlp_probability_distribution_case6.png")
    ...
    plot_model(
        model,
        to_file=str(visuals_dir / "mlp_architecture_case6.png"),
        show_shapes=True,
        show_layer_names=True,
        dpi=200
    )

    print("Saved: final_project/visuals/mlp_architecture_case6.png")

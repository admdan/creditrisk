...
def main():
    ...
    data_path = "data/synthetic_credit_risk_v2.csv"
    ...
    plt.title("MLP Training and Validation Loss (v2)")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("visuals/mlp_loss_curve_v2.png", dpi=200)
    plt.show()

    print("\nLoss curve saved as visuals/mlp_loss_curve_v2.png")
    ...
    plt.title("Confusion Matrix (MLP v2)") # Change for every version
    plt.colorbar()
    ...
    plt.tight_layout()
    plt.savefig("visuals/mlp_confusion_matrix_v2.png", dpi=200)
    plt.show()

    print("Saved: visuals/mlp_confusion_matrix_v2.png")
    ...
    plt.ylabel("Count")
    plt.title("Predicted Probability Distribution by Class (v2)")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("visuals/mlp_probability_distribution_v2.png", dpi=200)
    plt.show()

    print("Saved: visuals/mlp_probability_distribution_v2.png")
